...
cardRow1Col1.addEventListener("click",function () {
    if (flagCouple1 === 0 && flagLockGame === 0) {
        ...
        checkCountTriesLeft(flagCouple1);
    }
});
cardRow1Col2.addEventListener("click",function () {
    if (flagCouple2 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple2);
    }
});
cardRow1Col3.addEventListener("click",function () {
    if (flagCouple3 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple3);
    }
});
...
cardRow2Col2.addEventListener("click",function () {
    if (flagCouple4 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple4);
    }
});
cardRow2Col3.addEventListener("click",function () {
    if (flagRow2Col3 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple5);
    }
});
...
cardRow3Col1.addEventListener("click",function () {
    if (flagCouple6 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple6);
    }
});
cardRow3Col2.addEventListener("click",function () {
    if (flagCouple7 ===  0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple7);
    }
});
...
cardRow3Col4.addEventListener("click",function () {
    if (flagCouple8 === 0 && flagLockGame === 0){
        ...
        checkCountTriesLeft(flagCouple8);
    }
});
...
cardRow4Col4.addEventListener("click",function () {
    if (flagCouple5 === 0 && flagLockGame === 0){
